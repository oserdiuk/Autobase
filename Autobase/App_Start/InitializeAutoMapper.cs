...
namespace Autobase.App_Start
{
    public static class InitializeAutoMapper
    {
        ...
        private static void CreateMapperToViewModel()
        {
            ...
            Mapper.CreateMap<Driver, DriversHoursInRoadViewModel>()
                .ForMember(driver => driver.DriverSecondName, a => a.MapFrom(src => src.User.SecondName))
                .ForMember(driver => driver.DriverId, a => a.MapFrom(src => src.DriverId))
                .ForMember(driver => driver.AllHoursInRoad, a => a.MapFrom(src => TimeSpan.FromTicks(src.Routes.Select(r => r.ArrivalDate.Ticks - r.DepartureDate.Ticks).Sum(t => t))))
                .ForMember(driver => driver.DriverCarsHours, a => a.MapFrom(src => BBL.DbManager.DbManager.GetDriversCarsAndHours(src)))
                .ForMember(driver => driver.DriverDirectionsHours, a => a.MapFrom(src => BBL.DbManager.DbManager.GetDriversDirectionsAndHours(src)))
                .ForMember(driver => driver.DriverFirstName, a => a.MapFrom(src => src.User.FirstName));
        }
